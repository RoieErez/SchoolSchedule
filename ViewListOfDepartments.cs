...
{
    public partial class ViewListOfDepartments : Form
    {
        ...
        public ViewListOfDepartments()
        {
            InitializeComponent();
        }

        private void ViewListOfDepartments_Load(object sender, EventArgs e) //  load
        {
            SqlConnection conDataBase = new SqlConnection(constring);
            SqlCommand cmdDataBase = new SqlCommand(" select * from Departments ;", conDataBase);
