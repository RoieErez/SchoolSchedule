...
{
    public partial class ListOfClasses : Form
    {
        ...
        private void ListOfClasses_Load(object sender, EventArgs e)
        {
            SqlConnection conDataBase = new SqlConnection(constring);
            SqlCommand cmdDataBase = new SqlCommand(" select Id,Capacity from Classes ;", conDataBase);
