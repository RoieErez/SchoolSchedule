...
{
    public partial class HOD_Assign_lecturer : Form
    {
        ...
        private void HOD_Assign_lecturer_and_pract_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt2 = Program.get_dt("SELECT id FROM Teaching_staff where type= 'Lecturer'");
        ...
        private void HOD_Assign_lecturer_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
