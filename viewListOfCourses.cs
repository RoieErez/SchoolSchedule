...
{
    public partial class viewListOfCourses : Form
    {
        ...
        public viewListOfCourses()
        {
            InitializeComponent();
        }

        private void viewListOfCourses_Load(object sender, EventArgs e)
        {
            SqlConnection conDataBase = new SqlConnection(constring);
            SqlCommand cmdDataBase = new SqlCommand(" select * from Courses ;", conDataBase);
