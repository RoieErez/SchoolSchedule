...
{
    public partial class viewListOfEmployees : Form
    {
        ...
        public viewListOfEmployees()
        {
            InitializeComponent();
        }

        private void viewListOfEmployees_Load(object sender, EventArgs e)
        {
            SqlConnection conDataBase = new SqlConnection(constring);
            SqlCommand cmdDataBase = new SqlCommand("select * from Teaching_staff", conDataBase);
        ...
        private void pictureBox2_Click(object sender, EventArgs e)  //  exit
        {
